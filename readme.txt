...
This plugin allows the end user to upload a new logo or add existng image as a logo.
...
At the moment unfortunately no. I wl be working on this in future upgrades
